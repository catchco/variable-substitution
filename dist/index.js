...
var envVariableUtility = {};

var hasRequiredEnvVariableUtility;

function requireEnvVariableUtility () {
	if (hasRequiredEnvVariableUtility) return envVariableUtility;
	hasRequiredEnvVariableUtility = 1;
	Object.defineProperty(envVariableUtility, "__esModule", { value: true });
	...
	envVariableUtility.isPredefinedVariable = isPredefinedVariable;
	...
	envVariableUtility.getVariableMap = getVariableMap;
	function isEmpty(object) {
	    if (object == null || object == "")
	        return true;
	    return false;
	}
	envVariableUtility.isEmpty = isEmpty;
	...
	envVariableUtility.isObject = isObject;
	class EnvTreeUtility {
	    ...
	    checkEnvTreePath(jsonObjectKey, index, jsonObjectKeyLength, envVarTree) {
	        ...
	        return this.checkEnvTreePath(jsonObjectKey, index + 1, jsonObjectKeyLength, jsonObjectKeyChild);
	    }
	}
	envVariableUtility.EnvTreeUtility = EnvTreeUtility;
	return envVariableUtility;
}

var jsonVariableSubstitutionUtility = {};

var hasRequiredJsonVariableSubstitutionUtility;

function requireJsonVariableSubstitutionUtility () {
	if (hasRequiredJsonVariableSubstitutionUtility) return jsonVariableSubstitutionUtility;
	hasRequiredJsonVariableSubstitutionUtility = 1;
	Object.defineProperty(jsonVariableSubstitutionUtility, "__esModule", { value: true });
	const core = requireCore$1();
	const envVariableUtility_1 = requireEnvVariableUtility();
	...
	jsonVariableSubstitutionUtility.JsonSubstitution = JsonSubstitution;
	return jsonVariableSubstitutionUtility;
}
...
function require_escape () {
	...
	_escape.escapeXML = function escapeXML (s) {
	  return s.replace(/&|<|>|"|'/g, escapeXMLReplace)
	};

	_escape.unescapeXML = function unescapeXML (s) {
	  var result = '';
	  var start = -1;
	  var end = -1;
	  var previous = 0;
	...
	_escape.escapeXMLText = function escapeXMLText (s) {
	  return s.replace(/&|<|>/g, escapeXMLReplace)
	};

	_escape.unescapeXMLText = function unescapeXMLText (s) {
...
function requireEqual () {
	...
	equal.name = nameEqual;
	equal.attrs = attrsEqual;
	equal.children = childrenEqual;
	equal.equal = equal$1;
	return equal;
}
...
var hasRequiredLtx$1;

function requireLtx$1 () {
	if (hasRequiredLtx$1) return ltx.exports;
	hasRequiredLtx$1 = 1;
	...
	var SaxLtx = ltx.exports = function SaxLtx () {
...
function requireCreateElement () {
	 ...
	 */
	createElement = function createElement (name, attrs /*, child1, child2, ... */) {
...
var tagString;
var hasRequiredTagString;

function requireTagString () {
	if (hasRequiredTagString) return tagString;
	hasRequiredTagString = 1;

	var escape = require_escape().escapeXML;

	tagString = function tagString (/* [literals], ...substitutions */) {
...
function requireTag () {
	...
	var tagString = requireTagString();
	var parse = requireParse();

	tag = function tag (/* [literals], ...substitutions */) {
...
function requireIs () {
	...
	is.isNode = function is (el) {
	  return el instanceof Element || typeof el === 'string'
	};

	is.isElement = function isElement (el) {
	  return el instanceof Element
	};

	is.isText = function isText (el) {
...
function requireLtx () {
	if (hasRequiredLtx) return ltx$1.exports;
	hasRequiredLtx = 1;
	(function (module, exports) {
		...
		var escape = require_escape();
		var Element = requireElement();
		var equal = requireEqual();
		var createElement = requireCreateElement();
		var tag = requireTag();
		var tagString = requireTagString();
		var is = requireIs();
		var clone = requireClone();
	...
	return ltx$1.exports;
}

var hasRequiredXmlDomUtility;

function requireXmlDomUtility () {
	if (hasRequiredXmlDomUtility) return xmlDomUtility;
	hasRequiredXmlDomUtility = 1;
	Object.defineProperty(xmlDomUtility, "__esModule", { value: true });
	var envVarUtility = requireEnvVariableUtility();
	var ltx = requireLtx();
	class XmlDomUtility {
	...
	xmlDomUtility.XmlDomUtility = XmlDomUtility;
	return xmlDomUtility;
}

var xmlVariableSubstitution = {};

var hasRequiredXmlVariableSubstitution;

function requireXmlVariableSubstitution () {
	if (hasRequiredXmlVariableSubstitution) return xmlVariableSubstitution;
	hasRequiredXmlVariableSubstitution = 1;
	Object.defineProperty(xmlVariableSubstitution, "__esModule", { value: true });
	const core = requireCore$1();
	let envVarUtility = requireEnvVariableUtility();
	...
	xmlVariableSubstitution.XmlSubstitution = XmlSubstitution;
	return xmlVariableSubstitution;
}
...
function requireUtility () {
	...
	var __importStar = (utility && utility.__importStar) || function (mod) {
	    if (mod && mod.__esModule) return mod;
	    var result = {};
	    if (mod != null) for (var k in mod) if (Object.hasOwnProperty.call(mod, k)) result[k] = mod[k];
	    result["default"] = mod;
	...
	const core = requireCore$1();
	const os = __importStar(require$$1);
	const minimatch = __importStar(requireMinimatch());
	const fs = require$$0;
...
var fileEncodingUtility = {};

var hasRequiredFileEncodingUtility;

function requireFileEncodingUtility () {
	if (hasRequiredFileEncodingUtility) return fileEncodingUtility;
	hasRequiredFileEncodingUtility = 1;
	Object.defineProperty(fileEncodingUtility, "__esModule", { value: true });
	const core = requireCore$1();
	...
	fileEncodingUtility.detectFileEncoding = detectFileEncoding;
	return fileEncodingUtility;
}

var hasRequiredVariableSubstitution;

function requireVariableSubstitution () {
	if (hasRequiredVariableSubstitution) return variableSubstitution$1;
	hasRequiredVariableSubstitution = 1;
	var __awaiter = (variableSubstitution$1 && variableSubstitution$1.__awaiter) || function (thisArg, _arguments, P, generator) {
	    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
	    return new (P || (P = Promise))(function (resolve, reject) {
	        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
	        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
	...
	Object.defineProperty(variableSubstitution$1, "__esModule", { value: true });
	const core = requireCore$1();
	const envVariableUtility_1 = requireEnvVariableUtility();
	const jsonVariableSubstitutionUtility_1 = requireJsonVariableSubstitutionUtility();
	const xmlDomUtility_1 = requireXmlDomUtility();
	const xmlVariableSubstitution_1 = requireXmlVariableSubstitution();
	const utility_1 = requireUtility();
	const fs = require$$0;
	const yaml = requireJsYaml();
	const fileEncoding = requireFileEncodingUtility();
	...
	variableSubstitution$1.VariableSubstitution = VariableSubstitution;
	let varSub = new VariableSubstitution();
	varSub.run().catch((error) => {
	    core.setFailed(error);
	});
	return variableSubstitution$1;
}

var variableSubstitutionExports = requireVariableSubstitution();
var variableSubstitution = /*@__PURE__*/getDefaultExportFromCjs(variableSubstitutionExports);

export { variableSubstitution as default };
